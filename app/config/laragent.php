...
return [
    ...
    'providers' => [
        ...
        /**
         * Named rather than relying on 'default', which is also OpenAI: a role
         * in config/models.php that says `openai` should not need a reader to
         * know what 'default' happens to be pointing at this week.
         */
        'openai' => [
            'label' => 'openai',
            'api_key' => env('OPENAI_API_KEY'),
